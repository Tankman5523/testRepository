...
<body>
	...
	<div align="center" class="outer" style="height:900px">
		<br>
		...
		<form action="<%=contextPath%>/insert.ph" method="post" id="enroll-form" enctype="multipart/form-data">
			...
			<table align="center">
				...
				<tr>
					<th>내용</th>
					<td colspan="3"><textarea name="content" rows="10" cols="30" style="resize:none" required></textarea></td>
				</tr>
				<tr>
					<th>대표이미지</th>
			...
			<!-- 파일 첨부 영역 -->
			<div id="file-area" style="width:500px" align="center">
		...
		<script>
			...
			function loadImg(inputFile,num){
				...
				//파일 선택시 length가 1이 반환된다. 취소하면 파일 정보가 없어지니 length가 0이 된다.
				...
				if(inputFile.files.length ==1){
					...
					reader.onload = function(e){//e : 이벤트객체
						...
						//부여된 url은 target에 result속성에 들어있다. 
						//해당 result를 img src속성에 부여하면 미리보기 가능
						switch(num){

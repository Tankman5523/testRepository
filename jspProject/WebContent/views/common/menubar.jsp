...
<title>my web</title>
    <style>
        ...
        .menu{
            display: table-cell; /*인라인 요소처럼 배치. 인라인블럭이랑 동일하게 적용됨*/
            height: 50px;
            width: 150px;
        }
        ...
        .menu a{
            ...
            font-size: 22px;
            font-weight: bold;
            display: block; /*block으로 지정후 width/height 100%하면 해당 블럭에 꽉차게 설정 가능*/
...
<body>
    <script>
    	//script태그 내에서도 스크립틀릿과같은 jsp요소를 사용할 수 있다.
    	var msg = "<%=alertMsg%>";//성공적으로 로그인 되었습니다. / null
    	
    	if(msg!="null"){
    		alert(msg);
    		
    		//알람메세지 한번 띄웠으면 지워주기. 지우지 않으면 매번 menubar.jsp가 열릴떄마다 알림뜸
